...
public enum CameraControlType : int
{
    FirstPerson = 0,
    Legacy = 1,
    Standard = 2
...
public unsafe struct GameCamera {
    ...
    [FieldOffset(0x148)] public int FirstPersonVDelta;
    ...
    [FieldOffset(0x178)] public int ControlType2; // 0 first person, 1 legacy, 2 standard, 3/5/6 ???, 4 ???
    ...
    [FieldOffset(0x1C0)] public float LookAtX2; // Position that the camera is focused on (Actual position when zoom is 0)
    [FieldOffset(0x1C4)] public float LookAtZ2;
    [FieldOffset(0x1C8)] public float LookAtY2;
    [FieldOffset(0x1D8)] public byte field_1d8; // dunno
    ...
    [FieldOffset(0x2B4)] public float LookAtZ3;
    [FieldOffset(0x2D4)] public byte Mode2; // dunno
    [FieldOffset(0x2D8)] public byte field_2d8; // dunno
}
